    ...
    templates: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            key: 'actionCard.singleTitle',
            description: '单个按钮的标题',
            required: true
          },
          {
            key: 'actionCard.singleURL',
            description: '点击按钮触发的URL',
            required: true
          },
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            description: '按钮列表',
            placeholder:
              '按钮列表，格式为JSON数组：[{"title":"按钮标题","actionURL":"跳转链接"}]',
            required: true,
            component: 'textarea'
          },
          { key: 'msgtype', component: 'hidden', defaultValue: 'actionCard' }
  ...
  async sendMessage(
    ...
    try {
      ...
      if (
        ...
        message.actionCard?.btns &&
        typeof message.actionCard.btns === 'string'
      ) {
        message.actionCard.btns = JSON.parse(
          message.actionCard.btns as unknown as string
        );
      }
