...
export class FeishuChannel extends BaseChannel {
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            description:
              "富文本内容(JSON格式), 具体格式请参考<a target='_blank' href='https://open.feishu.cn/document/client-docs/bot-v3/add-custom-bot#f62e72d5'>飞书文档</a>",
            required: true,
            component: 'textarea',
  ...
  async sendMessage(
    ...
    if (
      ...
      typeof message.content.post?.zh_cn.content === 'string'
    ) {
      try {
        message.content.post.zh_cn.content = JSON.parse(
          message.content.post.zh_cn.content as any
        );
      } catch {
